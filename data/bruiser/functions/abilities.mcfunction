...
item replace entity @a[nbt={Inventory:[{id:"minecraft:iron_ingot"}]},nbt=!{Inventory:[{id:"minecraft:netherite_axe"}]}] hotbar.0 with netherite_axe{Enchantments:[{id:sharpness,lvl:5}]}
