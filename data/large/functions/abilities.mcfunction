...
execute as @e[type=area_effect_cloud,nbt={Potion:"minecraft:luck"}] at @s run execute at @e[type=!area_effect_cloud,type=!creeper,distance=..4] positioned ~ ~1.2 ~ facing entity @s feet run summon creeper ^ ^0.1 ^0.5 {Fuse:0,ExplosionRadius:-1}
