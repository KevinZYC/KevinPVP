...
execute positioned ~ ~-0.7 ~ run effect give @e[distance=0..1.6,type=!snowball] instant_damage 1 1
execute positioned ~ ~-0.7 ~ run effect give @e[distance=0..1.6,type=!snowball] glowing 1 1
